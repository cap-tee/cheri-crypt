...
#added extra encrypt bit to perms
#define TEST_CASE_ROOT_CAP_NO_OFFSET(testnum, testcap, code...) \
    TEST_CASE_CAP_NO_OFFSET(testnum, testcap, 1, 0x0, 0xffffffff, 0b1011110111110, 0xffffffff, code)

#added extra encrypt bit to perms
#define TEST_CASE_ROOT_CAP(testnum, testcap, code...) \
    TEST_CASE_CAP(testnum, testcap, 1, 0x0, 0xffffffff, 0x0, 0b1011110111110, 0xffffffff, code)
