...
class AES_Enc_withTestVectors extends Component {
  ...
  val crypto_core = new AES_Enc(dataWidth = 128 bits)
  val testVectors = new AES_Enc_TestVectors(dataWidth = 128 bits)
