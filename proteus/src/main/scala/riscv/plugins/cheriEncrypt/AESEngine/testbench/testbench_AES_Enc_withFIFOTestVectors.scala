...
import AESEngine.{AES_Enc_withFIFOTestVectors, AES_Enc, AES_engine, gfm128_16}

// simulation libraries needed for testbench
import spinal.sim._
import spinal.core.sim._

object testbench_AES_Enc_withFIFOTestVectors {

  def main(args: Array[String]): Unit = {
    SimConfig.withWave
      .compile(new AES_Enc_withFIFOTestVectors())
      .doSim("testbench_AES_Enc_withFIFOTestVectors") {
