...
import AESEngine.{AES_Dec_withTestVectors, AES_Dec_TestVectors, AES_Dec, AES_engine, gfm128_16}

// simulation libraries needed for testbench
import spinal.sim._
import spinal.core.sim._

object testbench_AES_Dec_withTestVectors {

  def main(args: Array[String]): Unit = {
    SimConfig.withWave
      .compile(new AES_Dec_withTestVectors())
      .doSim("testbench_AES_Dec_TestVectors") {
